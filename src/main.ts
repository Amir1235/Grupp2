...
const book5 = new Book(5, "https://d28hgpri8am2if.cloudfront.net/book_images/onix/cvr9781524861759/pride-and-prejudice-9781524861759_hr.jpg", "Pride and Prejudice", 300, "Jane  Austen", "Romantik", false);
const book6 = new Book(6, "https://m.media-amazon.com/images/I/515zE1GxvAL._AC_UF1000,1000_QL80_.jpg", "Frankenstein", 350, "Mary Shelley", "Skräck", true);
const book7 = new Book(7, "https://image.bokus.com/images/9789129723649_383x_pippi-langstrump-gar-ombord", "Pippi Långstrump", 200, "Astrid Lindgren", "Barn", true) 
const book8 = new Book(8, "https://image.bokus.com/images/9789137158952_383x_mirage", "Mirage", 245, "Camilla Läckberg, Henrik Fexeus", "Deckare", false);
const book9 = new Book(9, "https://imusic.b-cdn.net/images/item/original/138/9781665947138.jpg?lynn-painter-2024-nothing-like-the-movies-better-than-the-movies-inbunden-bok&class=scaled&v=1708417355", "Nothing Like the Movies", 250, "Lynn Painter", "Young Adult", true)
const book10 = new Book(10, "https://bilder.akademibokhandeln.se/images_akb/9780349439358_383/taming-7", "Taming 7", 250, "Chloe Walsh", "Drama", true)

//Skapar en lista och lägger in Böckerna som vi skapat
export const products: IBook[] = [book1, book2, book3, book4, book5, book6, book7, book8, book9, book10];
